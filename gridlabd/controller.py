...
while granted_time < request_time:
    ...
    print(granted_time)
    n3_va.append(h.helicsInputGetDouble(sub_n3_va))
    n5_va.append(h.helicsInputGetDouble(sub_n5_va))
    sw23_p.append(h.helicsInputGetDouble(sub_sw23_p))
    sw45_p.append(h.helicsInputGetDouble(sub_sw45_p))
    if granted_time == 3:
